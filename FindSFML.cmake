    ...
    # -----
    #
    # When you try to locate the SFML libraries, you must specify which engine you want to use (system, window, graphics, network, audio, main).
    # If none is given, the SFML_LIBRARIES variable will be empty and you'll end up linking to nothing.
    # example:
    #   find_package(SFML COMPONENTS graphics window system) # find the graphics, window and system engine
    #
    ...
    # - SFML_LIBRARIES:    the list of all libraries corresponding to the required engine
    # - SFML_FOUND:        true if all the required engine are found
    ...
    # we have to handle engine a little bit differently:
    ...
    set(SFML_FOUND TRUE) # will be init to false if one of the required engine is not found
